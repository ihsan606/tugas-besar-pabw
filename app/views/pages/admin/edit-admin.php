<div class="card card-tasks" style = 'height : 100%;'>
  <div class="card-header ">
    <h3 style = "margin : 0px 0px 0px 0px;">Edit Admin</h3>
  </div>
  <div class="card-body">
    ...
    <form action = "<?=BASEURL;?>/admin/kelola_admin/update/<?=$data['this_admin'][0]->id?>", method = "POST" enctype="multipart/form-data">
      <div class="row">
        <div class="col-md-6">
