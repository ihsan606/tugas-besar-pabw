                      ...
                      echo <<<TEXT
                        <td class='td-actions text-center' style='min-width:50px;'>
                          <button type='button' rel='tooltip' title='' class='btn btn-icon btn-info px-2 py-1' data-original-title='Edit Kategori'>
                            <a class='text-dark' href='$url/customer/cart/edit/$id' style = 'font-size : 18px;'><i class='tim-icons icon-pencil text-white'></i></a>
                          </button>
                          <button type='button' rel='tooltip' title='' class='btn btn-icon btn-danger px-2 py-1' data-original-title='Hapus Kategori'>
                            <a onclick="alert_warning('data keranjang akan dihapus secara permanen', 'ANDA YAKIN INGIN MENGHAPUS KERANJANG?', 'HAPUS!', '$url/customer/cart/removeChart/$id')" class='text-dark' style = 'font-size : 18px;'><i class='tim-icons icon-trash-simple text-white'></i></a>
                          </button>
                        </td>
                      </tr>
                    TEXT;
